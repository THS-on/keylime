...
class Example(policies.Policy):
    ...
    def refstate_to_test(self, refstate: policies.RefState) -> tests.Test:
        ...
        dispatcher.set(
            ...
            tests.Or(tests.OnceTest(tests.AcceptAll()), tests.OnceTest(tests.AcceptAll())),
        )
        ...
        db_test = tests.OnceTest(
            tests.Or(
                ...
                tests.Or(
                    tests.KeySubset("2616c4c1-4c50-9240-aca9-41f936934328", sigs_strip0x(refstate["db"])),
                    tests.KeySubset("c1c41626-504c-4092-aca9-41f936934328", sigs_strip0x(refstate["db"])),
                ),
            )
        )
        vd_driver_config.set(
